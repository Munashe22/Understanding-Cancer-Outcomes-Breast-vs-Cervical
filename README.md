...
The analysis combines unsupervised and supervised learning methods to identify patient subgroups, predict survival outcomes, and highlight key prognostic factors. This project is also personally meaningful to me, which motivated its execution and key questions
...
![Munashe Mhlanga](assets/munashe-mhlanga.png){width=50% alt="Munashe Mhlanga portrait"}
...
![Betsiet Delelegn](assets/betsiet-delelegn.png){width=50% alt="Betsiet Delelegn portrait"}
